...
$(TARGET_PREBUILT_INT_KERNEL): $(DEPMOD) $(KERNEL_MODULES_PARTITION_FILE_LIST) $(SYSTEM_KERNEL_MODULES_PARTITION_FILE_LIST)
	...
	$(hide) cd $(BUILD_TOP) && \
		python3 vendor/clover/build/tools/kernel_kleaf_manifest.py $(TARGET_KERNEL_VERSION) \
	...
	$(if $(filter $(TARGET_KERNEL_MIXED_MODE),true),\
		...
		($(call build-image-kernel-modules-clover,$$system_dlkm_modules,$(SYSTEM_KERNEL_MODULES_OUT),$(SYSTEM_KERNEL_MODULE_MOUNTPOINT)/,$(SYSTEM_KERNEL_DEPMOD_STAGING_DIR),$(SYSTEM_KERNEL_MODULES_LOAD),,$(SYSTEM_KERNEL_MODULES_PARTITION_FILE_LIST),))\
	)
