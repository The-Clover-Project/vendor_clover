...
PRODUCT_COPY_FILES += \
    vendor/clover/prebuilt/common/etc/sysconfig/preinstalled-packages-platform-clover-product.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/sysconfig/preinstalled-packages-platform-clover-product.xml
