...
PRODUCT_COPY_FILES += \
    $(call find-copy-subdir-files,*,vendor/clover/themes/fonts/prebuilt,$(TARGET_COPY_OUT_PRODUCT)/fonts) \
    vendor/clover/themes/fonts/config/fonts_customization.xml:$(TARGET_COPY_OUT_PRODUCT)/etc/fonts_customization.xml
